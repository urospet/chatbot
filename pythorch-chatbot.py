...
#Splits each line of the file into a dictionary of fields (lineID, charcterID, movieID, character, text)
...
#Groups fields of lines from 'loadLines' into conversations base on *movie_conversations.txt*
...
#Extracts pais of sentences from conversations
...
#Call the fonction and create the file *formatted_movie_lines.txt*
...
#        2. Prepare encoder's ginal hidden layer to be first hidden input to the decoder
